...
import { cn, getPasswordStrength, PASSWORD_CRITERIA } from "@plane/utils";
              ...
              <div className="flex items-center justify-center p-0.5">
                <CircleCheck
                  className={cn("h-3 w-3 flex-shrink-0", {
                    "text-green-500": criterion.isCriteriaValid(password),
                    "text-custom-text-100": !criterion.isCriteriaValid(password),
                  })}
                />
              </div>
              <span
