    ...
    <div className="relative h-screen overflow-x-hidden overflow-y-auto container px-5 mx-auto flex justify-center items-center">
      <div className="w-auto max-w-2xl relative space-y-8 py-10">
        <div className="relative flex flex-col justify-center items-center space-y-4">
          ...
          <h3 className="font-medium text-2xl text-white ">Não foi possível carregar os detalhes da instância.</h3>
          <p className="font-medium text-base text-center">
            Não foi possível carregar os detalhes da instância. <br />
            Não se preocupe, isso pode ser apenas uma questão de conexão.
          </p>
        </div>
